...
function About() {
 ...
 <div className="relative background overflow-hidden" id='about'>
  ...
  <section className="px-6 md:px-12 lg:px-20 py-16 md:py-24 relative z-20 font-[Salmond]">
    <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-start max-w-6xl mx-auto">
      ...
      <div>
        ...
        <h2 className="text-[#002733] text-4xl md:text-[45px] font-bold mb-10">
          Who we are
        </h2>
      ...
      <div>
        <h3 className="text-[#002733] text-3xl md:text-4xl font-bold mb-6">
          We are <span className="text-green-500">farapi</span>, a cutting edge company that delivers
        </h3>
